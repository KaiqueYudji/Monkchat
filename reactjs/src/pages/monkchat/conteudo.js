                    ...
                    {chat.map(x =>
                        <div key={x.id_chat}>
                            <div className="chat-message">
                                <div> <img onClick={() => editar(x)}   src="/assets/images/check.svg" style={{cursor:"pointer"}}/></div>
                                <div> <img onClick={ () => remover(x.id_chat)} src="/assets/images/lixeira.svg" alt="" style={{cursor:"pointer"}}/></div>
